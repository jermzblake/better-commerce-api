...
export class BadRequestError extends BetterError {
  constructor(moduleName: string, message: string, payload?: Payload, additionalInfo?: AdditionalInfo) {
...
export class UnauthorizedError extends BetterError {
  constructor(moduleName: string, message: string, payload?: Payload, additionalInfo?: AdditionalInfo) {
      super(moduleName, message, payload, additionalInfo)
      this.httpStatus = 401
  }
...
export class ForbiddenError extends BetterError {
  constructor(moduleName: string, message: string, payload?: Payload, additionalInfo?: AdditionalInfo) {
      super(moduleName, message, payload, additionalInfo)
      this.httpStatus = 403
  }
...
export class NotFoundError extends BetterError {
  constructor(moduleName: string, message: string, payload?: Payload, additionalInfo?: AdditionalInfo) {
      super(moduleName, message, payload, additionalInfo)
      this.httpStatus = 404
  }
...
export class MethodNotAllowedError extends BetterError {
  constructor(moduleName: string, message: string, payload?: Payload, additionalInfo?: AdditionalInfo) {
      super(moduleName, message, payload, additionalInfo)
      this.httpStatus = 405
  }
...
export class InternalServerError extends BetterError {
  constructor(moduleName: string, message: string, payload?: Payload, additionalInfo?: AdditionalInfo) {
      super(moduleName, message, payload, additionalInfo)
      this.httpStatus = 500
  }
